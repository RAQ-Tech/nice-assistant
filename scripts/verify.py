    ...
    if importlib.util.find_spec("ruff"):
        ...
        run(
            ...
            [
                ...
                "app/owner_profile_service.py",
                "app/persona_output.py",
                "app/private_memory_baseline.py",
                ...
                "scripts/drill_memory_reset.py",
                "scripts/evaluate_task_models.py",
                "scripts/evaluate_human_experience.py",
                "scripts/export_memory_baseline.py",
                "scripts/memory_extraction_baseline.py",
                ...
                "tests/test_persona_output.py",
                "tests/test_memory_v2.py",
                "tests/test_memory_grants.py",
                "tests/test_memory_extraction_baseline.py",
                "tests/test_module_contracts.py",
                "tests/test_ollama_provider.py",
                "tests/test_provider_readiness.py",
                "tests/test_production_hardening.py",
                "tests/test_private_memory_baseline.py",
